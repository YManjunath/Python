...
#Creatinig a deal_card() function that uses the List below to *return* a random card.
#11 is the Ace.
import random
...
#Creating a function called calculate_score() that takes a List of cards as input 
